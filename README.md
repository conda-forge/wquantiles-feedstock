...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/wquantiles-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12095&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/wquantiles-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `wquantiles` can be installed with:

```
conda install wquantiles
```

It is possible to list all of the versions of `wquantiles` available on your platform with:
